...
public class BlazorUpdateTestTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<BlazorUpdateTestTenantDatabaseMigrationHandler> _logger;

    public BlazorUpdateTestTenantDatabaseMigrationHandler(
        BlazorUpdateTestDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<BlazorUpdateTestTenantDatabaseMigrationHandler> logger)
    {
